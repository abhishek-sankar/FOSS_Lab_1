...
public class AnagramsActivity extends AppCompatActivity {
    ...
    public static final String START_MESSAGE = "Find as many words as possible that can be formed by adding %s to <big>%s</big> (but that do not contain the substring %s).";
    private AnagramDictionary dictionary;
    private String currentWord;
    private List<String> anagrams;
    public String state = "one Letter";
    ...
    public boolean defaultAction(View view) {
        ...
        if (currentWord == null) {
            ...
            if(state.equals("one Letter"))
                anagrams = dictionary.getAnagramsWithOneMoreLetter(currentWord);
            else if(state.equals("two Letters"))
                anagrams = dictionary.getAnagrams(currentWord);
            gameStatus.setText(Html.fromHtml(String.format(START_MESSAGE, state, currentWord.toUpperCase(), currentWord)));
